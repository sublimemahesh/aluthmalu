            ...
            <div class="widgets widgets-footer row">
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="single-widget widget-twitterfeed">
                        ...
                        <ul>
                            ...
                            <li><h6><a href="#"><i class="ion-ios-arrow-right"></i> About Us</a></h6></li>
                            <li><h6><a href="#"><i class="ion-ios-arrow-right"></i> Our Services</a></h6></li>
                            <li><h6><a href="#"><i class="ion-ios-arrow-right"></i> Oder Products</a></h6></li>
                            <li><h6><a href="#"><i class="ion-ios-arrow-right"></i> Contact Us</a></h6></li>
                        </ul>
                    </div>
                </div>
                <!--// Single Widget -->
                ...
                <div class="col-lg-3 col-md-6 col-12">
                    <div class="single-widget widget-twitterfeed">
                        ...
                        <ul>
                            <li><h6><a href="#"><i class="ion-android-star"></i> Fishing Competitions</a></h6></li>
                            <li><h6><a href="#"><i class="ion-android-star"></i> Fishing Equipments</a></h6></li>
                            <li><h6><a href="#"><i class="ion-android-star"></i> Fishing Guidence</a></h6></li>
                            <li><h6><a href="#"><i class="ion-android-star"></i> Fishing Tour</a></h6></li>
                            <li><h6><a href="#"><i class="ion-android-star"></i> Fishing Deals</a></h6></li>
                            <li><h6><a href="#"><i class="ion-android-star"></i> Fishing Boats</a></h6></li>
                        </ul>
                    </div>
                </div>
                <!--// Single Widget -->
