...
//Create 
    $("#create").click(function (event) {
        ...
        } else if (!$('#product_type').val() || $('#product_type').val().length === 0) {
            swal({
                title: "Error!",
                text: "Please enter the product_type..!",
                type: 'error',
                timer: 1500,
                showConfirmButton: false
            });
        ...
        } else if (!$('#unit').val() || $('#unit').val().length === 0) {
            swal({
                title: "Error!",
            ...
            $.ajax({
                ...
                success: function (result) {
                    swal({
                        ...
                        setTimeout(function () {
                            window.location.replace("./create-product.php");
                        }, 1500);
                    });
                },
                cache: false,
