                            ...
                            <div class="body">
                                <form class="form-horizontal" method="post" action="post-and-get/album-photo.php" enctype="multipart/form-data"> 
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                <input type="text" id="caption" class="form-control"  value="<?php echo $ALBUM_PHOTO->caption; ?>"  name="caption"  required="TRUE">
                                                <label class="form-label">Caption</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12"> 
                                        <input type="hidden" id="oldImageName" value="<?php echo $ALBUM_PHOTO->image_name; ?>" name="oldImageName"/>
                                        <input type="hidden" id="id" value="<?php echo $ALBUM_PHOTO->id; ?>" name="id"/>
