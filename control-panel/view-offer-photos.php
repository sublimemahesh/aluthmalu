...
<html> 
    ...
    <body class="theme-red">
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                                ...
                                <div class="row clearfix">
                                    ...
                                    if (count($OFFER_PHOTO) > 0) {
                                        foreach ($OFFER_PHOTO as $key => $offer_photo) {
                                            ?>
                                            <div class="col-md-3"  id="div<?php echo $offer_photo['id']; ?>">
                                                ...
                                                <div class="img-caption">
                                                    ...
                                                    <div class="d">
                                                        <a href="#" class="delete-offer-photo" data-id="<?php echo $offer_photo['id']; ?>"> <button class="glyphicon glyphicon-trash delete-btn"></button></a>
                                                        <a href="edit-offer-photo.php?id=<?php echo $offer_photo['id']; ?>"> <button class="glyphicon glyphicon-pencil edit-btn"></button></a>
                                                        <a href="arrange-offer-photos.php?id=<?php echo $id; ?>">  <button class="glyphicon glyphicon-random arrange-btn"></button></a>
                                                    </div>
                                                </div>
                                            </div>
                                            <?php
        ...
        <script src="js/demo.js"></script>
        <script src="delete/js/offer-photo.js" type="text/javascript"></script>
